...
| [Bananas]({{ site.url }}/rabbits/what-do-rabbits-eat.html#can-rabbits-eat-bananas---in-small-amounts)           | [Cabbage]({{ site.url }}/rabbits/what-do-rabbits-eat.html#can-rabbits-eat-cabbage---in-moderation)         |
...
_So what can rabbits eat? Let's dive into the list!_
...
Apples originate from Central Asia and their skin is generally red, yellow or green.
...
Most people know celery from grocery stores where most part of the leaves have been chopped off. If you are wondering whether your rabbit can also eat the celery leaves then the answer is yes. A nice little tip is to **try and find a place that sells the celery as a whole**. Your bunny will love the lush dark green celery leaves!
...
_In conclusion, rabbits can have celery and from what we read, many bunnies seem to like it quite a bit._
...
The banana is an edible fruit, that from a botanical point of view, is actually a berry. While the [original wild bananas contain large seeds](https://en.wikipedia.org/wiki/Banana#Modern_cultivation){:target="_blank"}, bananas for human consumption are grown asexually from offshoots and have tiny infertile black specks where the seeds used to be.
...
## Can Rabbits Eat Cabbage? - *In Moderation*{:.blue}

<img src="{{ site.url }}/assets/images/food/cabbage.jpg" alt="cabbage" class="align-right">

Cabbage is a [multi-layered vegetable](https://en.wikipedia.org/wiki/Cabbage){:target="_blank"}, grown for its dense-leaved head. Within the cabbage family, there are three main cultivar groups: **savoy cabbage, red cabbage, and white cabbage**.
...
We also came across some [accounts](http://www.binkybunny.com/FORUM/tabid/54/aft/124444/Default.aspx){:target="_blank"} that mention cabbage might **cause gas with rabbits**. This assumption is probably based on the fact that [people often get gas from cruciferous vegetables](https://en.wikipedia.org/wiki/Flatulence#Cause){:target="_blank"} like cabbage. However, we were not able to find scientific evidence to support this statement in the case of rabbits and it looks like this has more to do with the fact that **some rabbits are more sensitive to certain vegetables** than others. Actually, it is foods that are high in starch and sugars that are more likely to throw off a rabbit's GI tract.
...
_This was a tricky one, rabbits can eat cabbage leaves but remember to alternate with other greens._

## Can Rabbits Eat Broccoli - *In Lesser Amounts*{:.blue}

<img src="{{ site.url }}/assets/images/food/broccoli.jpg" alt="broccoli" class="align-right">
...
## Can Rabbits Eat Spinach? - *In Moderation*{:.green}
